# VAPI System Prompt - STRICT Authentication (FINAL)

Copy this EXACT prompt into your VAPI assistant:
...
The problem is Luna is **speaking the entire firstMessage** including credentials.

**The fix:**
- Luna must **extract and validate SILENTLY**
- Luna must **strip credentials before speaking**
- On failure: Say **ONLY** "Authentication failed. Access denied."

Update your VAPI assistant with this prompt and test again with `customer_id: "nothing"`.

Luna should say: **"Authentication failed. Access denied."** (and nothing else!)
